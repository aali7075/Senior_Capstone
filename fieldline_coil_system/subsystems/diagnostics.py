...
# freq = 10
# freq_sweep = 1.5
# bfreq, bdense, cfreq, cdense = coil_diagnostics(baseline, coil, freq, freq_sweep, sampling_rate)
...
def coil_diagnostics(baseline, coil, freq, freq_sweep, sampling_rate):
